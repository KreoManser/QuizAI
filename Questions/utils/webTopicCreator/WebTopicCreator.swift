...
class WebTopicCreator {
	...
	func outputWebCode(
        numberOfSets: UInt8,
        questionsPerSet: UInt8,
        answersPerQuestion: UInt8
    ) -> String {
		return """
		<!DOCTYPE html>
		<html>
	...
	private var options: String {
		...
		<section id="full-options" style="margin-top: 10pt">
			...
			<section id="options-content" style="display: none">
				...
				<div class="input-group mb-3">
					<div class="input-group-prepend">
						<span class="input-group-text\(extraInputGroupStyle)">\(L10n.TopicsCreation_WebView_Options_AIOrderQuestions)</span>
                            ...
                            <section id="full-question-\(i)-\(j)" style="margin-top: 10pt; margin-left: 6pt">
                                ...
                                <section id="question-\(i)-\(j)-content" style="display: none; margin-top: 10pt">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <select class="form-control" id="question-difficulty-\(i)-\(j)">
                                            <option value="Easy">Easy</option>
                                            <option value="Medium">Medium</option>
                                            <option value="Hard">Hard</option>
                                        </select>
                                    </div>
                                    <div id="answers-\(i)-\(j)" style="padding-top: 10pt">
