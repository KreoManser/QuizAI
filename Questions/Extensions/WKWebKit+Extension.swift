...
extension WKWebView {
    ...
    func questionAndAnswers(
        ...
        for (questionID, questionImageID, difficultyID, answerIDs) in questionAndAnswersIDs {
            ...
            let difficultyByID = #"document.getElementById("\#(difficultyID)").value"#

            elementsByID.append(#"{ question: document.getElementById("\#(questionID)").value, questionImage: \#(questionImageByID), difficulty: \#(difficultyByID), answers: \#(answers) }"#)
        }
