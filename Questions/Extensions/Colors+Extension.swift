...
extension UIColor {
	...
	static var popoverVCBackground: UIColor {
		return UserDefaultsManager.darkThemeSwitchIsOn ? UIColor(RGBred: 237, green: 177, blue: 98) : UIColor(RGBred: 64, green: 85, blue: 115)
	}
	static var popoverVCBackgroundSelected: UIColor {
		return UserDefaultsManager.darkThemeSwitchIsOn ? UIColor(RGBred: 237-30, green: 177-30, blue: 98-30) : UIColor(RGBred: 58, green: 76, blue: 100)
	}
